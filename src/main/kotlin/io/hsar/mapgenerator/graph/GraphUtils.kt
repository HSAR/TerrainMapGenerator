...
import io.hsar.mapgenerator.mergeReduce
...
object GraphUtils {
    ...
    fun generateCells(cellCentres: List<Point>, cellRegions: List<List<Point>>, cellJoins: Map<Int, List<Int>>): List<Cell> =
    ...
    fun Array<VoronoiEdge>.toAdjacentMap(): Map<Int, List<Int>> {
        ...
        return map1.mergeReduce(map2) { _, value1, value2 -> listOfNotNull(value1, value2).reduce { acc, curr -> acc + curr } }
    }
